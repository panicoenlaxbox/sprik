        ...
        <div className="ml-6 space-y-3 border-l-2 border-blue-100 pl-4">
          <div className="flex gap-3">
            <div className="flex flex-col gap-1">
              <label htmlFor="llm-provider-select" className="text-xs text-gray-500">Provider</label>
              <select
            ...
            <div className="flex flex-col gap-1">
              <label htmlFor="llm-model-select" className="text-xs text-gray-500">Model</label>
              <select
                id="llm-model-select"
